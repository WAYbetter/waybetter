...
var nav = navigator,
	...
	/* Message in various languages, en_us is the default if a language does not exist */
        intl = {
            ...
            en: 'Install this web app on your %device: tap `%icon` and then `<strong>Add to Home Screen</strong>`.',
            es_es: 'Para instalar esta app en su %device, pulse `%icon` y seleccione `<strong>Añadir a pantalla de inicio</strong>`.',
            fr: 'Ajoutez cette application sur votre %device en cliquant sur `%icon`, puis `<strong>Ajouter à l\'écran d\'accueil</strong>`.',
            he: '<span dir="rtl">לשמירת האפליקציה לחץ על %icon ובחר באפשרות "הוסף למסך הבית"</span>',
