...
def activate(request, backend,
    ...
    ``registration/activation_complete.html`` to display an error message; to
    ...
    **Arguments**
    ...
    ``template_name``
        ...
        this will default to ``registration/activation_complete.html``.
    ...
    **Template:**
    ...
    registration/activation_complete.html or ``template_name`` keyword argument.
