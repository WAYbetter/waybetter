...
class SoapClient(object):
    ...
    def __init__(self, location=None, action=None, namespace=None,
        ...
        self.services = wsdl and self.wsdl(wsdl, debug=True) # parse wsdl url
...
<%(soap_ns)s:Body>
    ...
    def call(self, method, parameters, *args, **kwargs):
...
if __name__ == "__main__":
    ...
    # raw (unmarshalled parameter) local sample webservice exposed by web2py
        ...
        params = SimpleXMLElement(
                """<?xml version="1.0" encoding="UTF-8"?><AddIntegers><a>3</a><b>2</b></AddIntegers>""") # manully convert returned type
